...
exports.default = async function extractTarball(tarballPath, destPath) {
  const stream = _fs2.default
    .createReadStream(tarballPath)
    .pipe(new _zlib2.default.Unzip())
    .pipe(_tarFs2.default.extract(destPath));
